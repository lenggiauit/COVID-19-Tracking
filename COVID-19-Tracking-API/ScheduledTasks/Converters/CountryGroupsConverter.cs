...
{
    public class CountryGroupsConverter : IConverter
    {
        private dynamic _jsonObject;
        public CountryGroupsConverter(dynamic jsonObject)
        {
        ...
        public string Convert()
        {
            if (_jsonObject != null)
            {
                List<CovidDataByRegion> covidDataByDayGroups = new List<CovidDataByRegion>();

                foreach (var topCountry in _jsonObject)
                {
                    string countryCode = topCountry["value"];
                    var item = topCountry["data"]["totals"];
                    var region = topCountry["data"]["rows"][0][1];
                    CovidDataByRegion covid19Data = new CovidDataByRegion();
                    covid19Data.CountryCode = countryCode;
                    covid19Data.RegionCode = region == null ? "": region;
                    covid19Data.Deaths = item[0] != null ? item[0] : 0;
                    covid19Data.CumulativeDeaths = item[1] != null ? item[1] : 0;
                    covid19Data.DeathsLast7Days = item[2] != null ? item[2] : 0;
                    covid19Data.DeathsLast7DaysChange = item[3] != null ? item[3] : 0;
                    covid19Data.DeathsPerHundredThousand = item[4] != null ? item[4] : 0;
                    covid19Data.Confirmed = item[5] != null ? item[5] : 0;
                    covid19Data.CumulativeConfirmed = item[6] != null ? item[6] : 0;
                    covid19Data.CasesLast7Days = item[7] != null ? item[7] : 0;
                    covid19Data.CasesLast7DaysChange = item[8] != null ? item[8] : 0;
                    covid19Data.CasesPerHundredThousand = item[9] != null ? item[9] : 0;
